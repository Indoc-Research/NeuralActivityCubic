...
# %% auto 0
__all__ = ['BaseConfigClass', 'AnalysisConfig', 'ResultsConfig', 'process_analysis_rois', 'AnalysisJob']
...
@dataclass
class AnalysisConfig(BaseConfigClass):
    window_size: int
...
@dataclass
class ResultsConfig(BaseConfigClass):
