...
# %% auto 0
__all__ = ['peak_input', 'BaselineEstimatorFactory', 'AnalysisROI', 'test_peak', 'test_required_peak', 'test_incorrect_peak']
...
peak_input = {
    ...
    'amplitude': 10.0,
    'delta_f_over_f': None,
    'has_neighboring_intersections': None,
...
def test_peak():
    try:
        Peak.validate(peak_input)
    except TypeError as e:
        print(e)
        return False

def test_required_peak():
    try:
        peak_input_required = {
            'frame_idx': 10,
            'intensity': 10.0,
        }
        Peak.validate(peak_input_required)
    except TypeError as e:
        print(e)
        return False

def test_incorrect_peak():
    try:
        peak_input.pop('intensity')
        Peak.validate(peak_input)
    except TypeError as e:
        print(e)
        return False
