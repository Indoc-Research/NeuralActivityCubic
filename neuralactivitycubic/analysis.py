...
class AnalysisROI:
    ...
    def compute_area_under_curve(self) -> None:
        ...
        for peak_frame_idx, peak in self.peaks.items():
            if peak.has_neighboring_intersections == True:
                ...
                peak.area_under_curve = np.trapezoid(self.mean_intensity_over_time[idx_before_peak:idx_after_peak + 1] - self.baseline[idx_before_peak:idx_after_peak + 1])
    ...
    def compute_variance_area(self, variance_window_size: int) -> None:
        ...
        self.variance_area = np.trapezoid(variance_area_upper_border - variance_area_lower_border)
