...
# %% auto 0
__all__ = ['Model', 'test_create_analysis']
...
def test_create_analysis():
    configs = WidgetsInterface().export_user_settings()
    recording_filepath = Path('../test_data/00/spiking_neuron.avi')
    configs['data_source_path'] = recording_filepath
    model = Model()
    model.create_analysis_jobs(configs)
